...
from src.rest_api import JSON_user, RestAPI

DATABASE_TYPE = dict[str, list[JSON_user]]


class TestRestApi:
    def test_no_users(self) -> None:
        database: DATABASE_TYPE = {"users": []}
        api = RestAPI(database)

        response = api.get("/users")
        expected: DATABASE_TYPE = {"users": []}
    ...
    def test_both_users_have_0_balance(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {}, "owed_by": {}, "balance": 0.0},
                {"name": "Bob", "owes": {}, "owed_by": {}, "balance": 0.0},
    ...
    def test_borrower_has_negative_balance(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {}, "owed_by": {}, "balance": 0.0},
    ...
    def test_lender_has_negative_balance(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {}, "owed_by": {}, "balance": 0.0},
                {"name": "Bob", "owes": {"Chuck": 3.0}, "owed_by": {}, "balance": -3.0},
    ...
    def test_lender_owes_borrower(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {"Bob": 3.0}, "owed_by": {}, "balance": -3.0},
    ...
    def test_lender_owes_borrower_less_than_new_loan(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {"Bob": 3.0}, "owed_by": {}, "balance": -3.0},
                {"name": "Bob", "owes": {}, "owed_by": {"Adam": 3.0}, "balance": 3.0},
    ...
    def test_lender_owes_borrower_same_as_new_loan(self) -> None:
        database: DATABASE_TYPE = {
            "users": [
                {"name": "Adam", "owes": {"Bob": 3.0}, "owed_by": {}, "balance": -3.0},
                {"name": "Bob", "owes": {}, "owed_by": {"Adam": 3.0}, "balance": 3.0},
